$(document).ready(function(){ 
	...
	/*$(this).on('change', 'input', function(){
		...
		console.log(viewCellFound);
		console.log(viewCellFound.innerHTML[1]);
		console.log(Number(viewCellFound.innerHTML[1]));

		var oldCellValue = Number(viewCellFound.text());
		...
		var newMargin = (changedScore - Number(parsArray[targetedCol]));
		...
		var newMarginTotal = (oldMarginTotal - oldCellValue) + (changedScore - Number(parsArray[targetedCol]))
	...
	$('#showFormButton').on('click', function(){
		...
		$('#scoreForm, #scoreboardTable').show();
	});
